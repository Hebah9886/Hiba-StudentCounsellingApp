...
import com.example.hiba_studentcounsellingapp.counsellor.CounsellorRegistration;
                    ...
                    if (paswordlength()) {
                        if(paswordmatch()){
                            if (nInfo != null && nInfo.isConnected()) {
                                ...
                                firebaseAuth.createUserWithEmailAndPassword(email_user, pass_user).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(StudentRegistration.this, "Successful Registration", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(StudentRegistration.this, "Network is not available", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                }
