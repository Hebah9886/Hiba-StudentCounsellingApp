...
import com.example.hiba_studentcounsellingapp.counsellor.DeleteAccountCounsellor;
...
public class DeleteAccountStduent extends AppCompatActivity {
    private TextView u_fname, u_lgender, u_phone, u_add, u_shop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_account_stduent);
        ...
        del_acc = (Button) findViewById(R.id.del_acc2);
        u_fname = (TextView) findViewById(R.id.u_fname2);
        u_lgender = (TextView) findViewById(R.id.u_lgender2);
        u_phone = (TextView) findViewById(R.id.u_phone2);
        u_add = (TextView) findViewById(R.id.u_add2);

        d_email = findViewById(R.id.d_email2);
        d_password = findViewById(R.id.d_password2);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                u_lgender.setText("Gender: "+userInfo.getUserGender());
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DeleteAccountStduent.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(DeleteAccountStduent.this, "Account Deleted,", Toast.LENGTH_LONG).show();
                                                    SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
                                                    SharedPreferences.Editor editor= sharedPreferences.edit();
                                                    editor.clear();
                                                    editor.commit();
                                                    firebaseAuth.signOut();
                                                    startActivity(new Intent(DeleteAccountStduent.this, UserType.class));
                                                    finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(DeleteAccountStduent.this, StudentHomePage.class));
        finish();
    }
}