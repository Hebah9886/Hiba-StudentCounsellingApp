...
public class ImageAdapterSearchByName extends FirebaseRecyclerAdapter<UserCounsellor, ImageAdapterSearchByName.ImageViewHolder> {
    private OnItemClickListener mListener;

    public ImageAdapterSearchByName(@NonNull FirebaseRecyclerOptions<UserCounsellor> options) {
        super(options);
    }
    @Override
    protected void onBindViewHolder(@NonNull ImageViewHolder holder, int position, @NonNull UserCounsellor model) {
        holder.textViewName.setText("Name: "+model.getCounsellorName());
