...
public class CounsellorLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p_email= (EditText) findViewById(R.id.p_email_m);
        p_password= (EditText) findViewById(R.id.p_password_m);
        sign= (TextView) findViewById(R.id.sign_m);
        login= (Button) findViewById(R.id.login_m);
        forgetP= (TextView) findViewById(R.id.forget_m);
                        ...
                        firebaseAuth.signInWithEmailAndPassword(ema_user, pas_user).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    editor.putString("name", "counsellor");
                                    editor.apply();
                                    //end

                                    Toast.makeText(CounsellorLogin.this, "Successful Login", Toast.LENGTH_LONG).show();
                                    startActivity(new Intent(CounsellorLogin.this, CounsellorHomePage.class));
                                    finish();
                                } else {
                                    Toast.makeText(CounsellorLogin.this, "Login Failed", Toast.LENGTH_SHORT).show();
                                    progressDialog.dismiss();
                                }
                            }
                        });
                    } else {
                        Toast.makeText(CounsellorLogin.this, "Network is not available", Toast.LENGTH_LONG).show();}
        ...
        sign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CounsellorLogin.this, CounsellorRegistration.class));
                finish();
            }
        });
        ...
        forgetP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CounsellorLogin.this, ForgetPassword1.class));
                finish();
            }
        });
    }
