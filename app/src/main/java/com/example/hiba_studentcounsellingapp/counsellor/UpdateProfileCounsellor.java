...
public class UpdateProfileCounsellor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_profile_counsellor);

        firebaseAuth = FirebaseAuth.getInstance();
        user = firebaseAuth.getCurrentUser();

        update=(Button) findViewById(R.id.vp_update_save);
        u_gender= (EditText) findViewById(R.id.uv_gender2);
        u_fname= (EditText) findViewById(R.id.uv_fname2);
        u_phone= (EditText) findViewById(R.id.uv_phone2);
        u_add= (EditText) findViewById(R.id.uv_add2);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(UpdateProfileCounsellor.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
                ...
                if(user!=null){
                    if (validate()) {
                        if (nInfo != null && nInfo.isConnected()) {
                            ...
                            Toast.makeText(UpdateProfileCounsellor.this, "Profile is Updated", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(UpdateProfileCounsellor.this, CounsellorHomePage.class));
                            finish();

                        }
                    } else {
                        Toast.makeText(UpdateProfileCounsellor.this, "Network is not available", Toast.LENGTH_LONG).show();
                    }
                }//user null
            }
        });
