...
public class DeleteAccountCounsellor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_account_counsellor);
        ...
        ref = FirebaseDatabase.getInstance().getReference("Service_Provider_Users").child(user.getUid()).child("Profile");

        del_acc = (Button) findViewById(R.id.del_acc1);
        u_fname = (TextView) findViewById(R.id.u_fname1);
        u_lgender = (TextView) findViewById(R.id.u_lgender1);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DeleteAccountCounsellor.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(DeleteAccountCounsellor.this, "Account Deleted,", Toast.LENGTH_LONG).show();
                                                    SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
                                                    SharedPreferences.Editor editor= sharedPreferences.edit();
                                                    editor.clear();
                                                    editor.commit();
                                                    firebaseAuth.signOut();
                                                    startActivity(new Intent(DeleteAccountCounsellor.this, UserType.class));
                                                    finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(DeleteAccountCounsellor.this, CounsellorHomePage.class));
        finish();
    }
}